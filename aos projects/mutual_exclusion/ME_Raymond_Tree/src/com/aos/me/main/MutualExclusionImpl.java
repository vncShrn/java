	...
	public static void main(String[] args) throws UnknownHostException {
		...
		if (Definitions.AM_I_COORDINATOR) {
			...
			try {
				...
				System.err.println(
						"REGISTRATION error: " + e.getMessage() + InetAddress.getLocalHost().getCanonicalHostName());
				System.exit(0);
			}
			...
			if (packet instanceof RegisterPacket) {
				...
				System.out.println(df.format(new Date()) + "REGISTRATION complete. Obtained processID: "
						+ process.getId() + ", portNo: " + process.getPortNo());
			}
